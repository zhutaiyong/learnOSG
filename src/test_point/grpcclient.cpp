...
osg::StateSet* MakeStateSet(int nSize)
{
...
//    stateSet->setAttributeAndModes(fn,osg::StateAttribute::ON);
    ...
    tex->setImage(osgDB::readImageFile("/home/dx/data/test/osgtest/thirdparty/OpenSceneGraph-Data-3.0.0/Images/yuan.png"));
...
osg::Node* createScene()
{
    ...
    // create POINTS
    {
        ...
        vertices->push_back(osg::Vec3(-10.02168, -2.15188e-09, 0.885735));
...
//        pointsGeom->setColorArray(colors, osg::Array::BIND_OVERALL);
        ...
        pointsGeom->setStateSet(MakeStateSet(10));
...
osg::Node* createBackground()
{
    ...
    osg::ref_ptr<osg::Image> image = osgDB::readRefImageFile("/home/dx/data/test/osgtest/thirdparty/OpenSceneGraph-Data-3.0.0/Images/primitives.gif");
